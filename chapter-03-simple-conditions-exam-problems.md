...
![](assets/images/chapter-3-2-images/01.Transport-price-03.png)
...
![](assets/images/chapter-3-2-images/01.Transport-price-04.png)
...
![](assets/images/chapter-3-2-images/01.Transport-price-05.png)
...
![](assets/images/chapter-3-2-images/01.Transport-price-06.png)
...
![](assets/images/chapter-3-2-images/02.Pipes-in-pool-01.png)
...
![](assets/images/chapter-3-2-images/02.Pipes-in-pool-02.png)
...
![](assets/images/chapter-3-2-images/02.Pipes-in-pool-03.png)
...
![](assets/images/chapter-3-2-images/03.Sleepy-tom-cat-01.png)
...
![](assets/images/chapter-3-2-images/03.Sleepy-tom-cat-02.png)
...
![](assets/images/chapter-3-2-images/03.Sleepy-tom-cat-03.png)
...
Тук трябва да отбележим, че ако полученото количество **време игра** на Том е **по-малко** от **30 000**, при **изваждането** на нормата от него ще получим **число с отрицателен знак**. За да **неутрализираме** знака в двете деления по-късно, ще използваме **функцията `Math.аbs(…)`** при намирането на разликата.

![](assets/images/chapter-3-2-images/03.Sleepy-tom-cat-04.png)
...
![](assets/images/chapter-3-2-images/03.Sleepy-tom-cat-05.png)
...
![](assets/images/chapter-3-2-images/04.Harvest-01.png)
...
![](assets/images/chapter-3-2-images/04.Harvest-02.png)
...
Ако проверката върне резултат **`true`**, от условието на задачата виждаме, че на **първия ред** трябва да разпечатаме **виното, което сме получили от реколтата**. За да спазим условието **тази стойност** да бъде **закръглена до по-ниското цяло число**, ще използваме функцията **`Math.floor(…)`** при разпечатването ѝ чрез **placeholder**. 
...
![](assets/images/chapter-3-2-images/04.Harvest-03.png)
...
![](assets/images/chapter-3-2-images/04.Harvest-04.png)
...
![](assets/images/chapter-3-2-images/05.Firm-01.png)
...
![](assets/images/chapter-3-2-images/05.Firm-02.png)
...
![](assets/images/chapter-3-2-images/05.Firm-03.png)
