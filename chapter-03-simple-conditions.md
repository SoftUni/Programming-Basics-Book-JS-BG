...
Да се напише функция, която **приема две думи** и проверява дали са еднакви. Да не се прави разлика между главни и малки букви. Да се изведе “**yes**” или “**no**”. 
...
Трябва да хванем следните **събития**, за да напишем JavaScript кода, който ще се изпълни при настъпването им:
