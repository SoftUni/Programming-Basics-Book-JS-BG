...
<table>
   <tr>
      ...
      <td>
         <img src="assets/old-images/chapter-8-1-images/01.Triangle-area-01.png"/>
      </td>
   </tr>
</table>
...
|----|----|----|----|
|5<br>-2<br>6<br>1<br>1<br>1|7.5|![](/assets/old-images/chapter-8-1-images/01.Triangle-area-01.png)|Страната на триъгълника **а** = 6 - 1 = **5**<br>Височината на триъгълника **h** = 1 - (-2) = **3**<br>Лицето на триъгълника **S** = a \* h / 2 = 5 \* 3 / 2 = **7.5**|

|Вход|Изход|Чертеж|Обяснения|
|----|----|----|----|
|4<br>1<br>-1<br>-3<br>3<br>-3|8|![](/assets/old-images/chapter-8-1-images/01.Triangle-area-02.png)|Страната на триъгълника **а** = 3 - (-1) = **4**<br>Височината на триъгълника **h** = 1 - (-3) = **4**<br>Лицето на триъгълника **S** = a \* h / 2 = 4 \* 4 / 2 = **8**|
...
![](assets/old-images/chapter-8-1-images/01.Triangle-area-03.png)
...
![](assets/old-images/chapter-8-1-images/01.Triangle-area-04.png)
...
![](assets/old-images/chapter-8-1-images/01.Triangle-area-05.png)

Единственото, което остава, е да отпечатаме лицето на конзолата.

![](assets/old-images/chapter-8-1-images/01.Triangle-area-06.png)
...
![](assets/old-images/chapter-8-1-images/02.Bricks-01.png)

Пресмятаме колко **тухли** носят работниците на един курс.

![](assets/old-images/chapter-8-1-images/02.Bricks-02.png)
...
![](assets/old-images/chapter-8-1-images/02.Bricks-03.png)

Накрая принтираме резултата на конзолата.

![](assets/old-images/chapter-8-1-images/02.Bricks-04.png)
...
|---|---|---|
|10<br>5<br>7|in<br>2|![](/assets/old-images/chapter-8-1-images/03.Point-on-segment-01.png)|

|Вход|Изход|Визуализация|
|---|---|---|
|8<br>10<br>5|out<br>3|![](/assets/old-images/chapter-8-1-images/03.Point-on-segment-02.png)|

|Вход|Изход|Визуализация|
|---|---|---|
|1<br>-2<br>3|out<br>2|![](/assets/old-images/chapter-8-1-images/03.Point-on-segment-03.png)|

#### Насоки и подсказки

Четем входа от конзолата.

![](assets/old-images/chapter-8-1-images/03.Point-on-segment-04.png)
...
![](assets/old-images/chapter-8-1-images/03.Point-on-segment-05.png)

По-малкото от двете **разстояния** ще намерим ползвайки **`Math.Min(…)`**.

![](assets/old-images/chapter-8-1-images/03.Point-on-segment-06.png)
...
![](assets/old-images/chapter-8-1-images/03.Point-on-segment-07.png)

Накрая принтираме **разстоянието**, намерено преди това.

![](assets/old-images/chapter-8-1-images/03.Point-on-segment-08.png)
...
![](/assets/old-images/chapter-8-1-images/04.Point-in-figure-01.png)
...
![](assets/old-images/chapter-8-1-images/04.Point-in-figure-02.png)
![](assets/old-images/chapter-8-1-images/04.Point-in-figure-03.png)

Достатъчно условие е **точката** да се намира в един от тях, за да се намира във **фигурата**.

Четем от конзолата входните данни:

![](assets/old-images/chapter-8-1-images/04.Point-in-figure-04.png)

Ще създадем две променливи, които ще отбелязват дали **точката** се намира в някой от правоъгълниците.

![](assets/old-images/chapter-8-1-images/04.Point-in-figure-05.png)
...
![](assets/old-images/chapter-8-1-images/04.Point-in-figure-06.png)
...
![](assets/old-images/chapter-8-1-images/05.Date-after-5-days-01.png)
...
![](assets/old-images/chapter-8-1-images/05.Date-after-5-days-02.png)

Увеличаваме **деня** с 5.

![](assets/old-images/chapter-8-1-images/05.Date-after-5-days-03.png)
...
![](assets/old-images/chapter-8-1-images/05.Date-after-5-days-04.png)
...
![](assets/old-images/chapter-8-1-images/05.Date-after-5-days-05.png)
...
![](assets/old-images/chapter-8-1-images/05.Date-after-5-days-06.png)
...
![](assets/old-images/chapter-8-1-images/06.Sums-3-numbers-01.png)
...
![](assets/old-images/chapter-8-1-images/06.Sums-3-numbers-02.png)
...
![](assets/old-images/chapter-8-1-images/06.Sums-3-numbers-03.png)

Аналогично, ще допълним и другите два случая. Пълният код на проверките и изходът на програмата ще изглеждат така:

![](assets/old-images/chapter-8-1-images/06.Sums-3-numbers-04.png)
...
![](assets/old-images/chapter-8-1-images/07.Sums-Step-3-01.png)
...
![](assets/old-images/chapter-8-1-images/07.Sums-Step-3-02.png)
...
![](assets/old-images/chapter-8-1-images/07.Sums-Step-3-03.png)

Накрая, ще отпечатаме резултата на конзолата в изисквания **формат**.

![](assets/old-images/chapter-8-1-images/07.Sums-Step-3-04.png)
...
![](assets/old-images/chapter-8-1-images/08.Increasing-numbers-01.png)
...
![](assets/old-images/chapter-8-1-images/08.Increasing-numbers-02.png)
...
![](assets/old-images/chapter-8-1-images/08.Increasing-numbers-03.png)

Накрая принтираме дължината на **най-дългата** намерена редица.

![](assets/old-images/chapter-8-1-images/08.Increasing-numbers-04.png)
...
![](assets/old-images/chapter-8-1-images/09.Perfect-diamond-01.png)
...
![](assets/old-images/chapter-8-1-images/09.Perfect-diamond-02.png)
...
![](assets/old-images/chapter-8-1-images/09.Perfect-diamond-03.png)
...
![](assets/old-images/chapter-8-1-images/09.Perfect-diamond-04.png)
...
![](assets/old-images/chapter-8-1-images/10.Rectangle-with-stars-01.png)
...
![](assets/old-images/chapter-8-1-images/10.Rectangle-with-stars-02.png)
...
![](assets/old-images/chapter-8-1-images/10.Rectangle-with-stars-03.png)
...
![](assets/old-images/chapter-8-1-images/10.Rectangle-with-stars-04.png)
...
![](assets/old-images/chapter-8-1-images/11.Increasing-4-numbers-01.png)
...
![](assets/old-images/chapter-8-1-images/11.Increasing-4-numbers-02.png)
...
![](assets/old-images/chapter-8-1-images/11.Increasing-4-numbers-03.png)

Накрая ще проверим дали **броячът** е равен на **0** и съответно ще принтираме “**No**” на конзолата, ако е така.

![](assets/old-images/chapter-8-1-images/11.Increasing-4-numbers-04.png)
...
![](assets/old-images/chapter-8-1-images/12.Generating-rectangles-01.png)
...
![](assets/old-images/chapter-8-1-images/12.Generating-rectangles-02.png)
...
![](assets/old-images/chapter-8-1-images/12.Generating-rectangles-03.png)

Накрая принтираме “**No**”, ако не съществуват такива правоъгълници.

![](assets/old-images/chapter-8-1-images/12.Generating-rectangles-04.png)
