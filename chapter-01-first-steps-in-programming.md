...
Можем да усложним предходната програма, като зададем за изпълнение повтарящи се в цикъл команди за нотифициране на потребителя, че е победител в томбола - нещо което също доста често се случва:
