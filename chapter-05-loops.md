...
* Интерактивен онлайн инструмент за чертане с костенурка – [http://davidbau.github.io/jquery-turtle/demo.html](http://davidbau.github.io/jquery-turtle/demo.html)

Разполагаме с две възможности, за да създадем нашето приложение - Turtle Graphics.

+ **Зареждане на ресурсите чрез CDN.**
...
Всички необходими ресурси ще се зареждат автоматично при стартирането на файла и можем директно да започнем с въвеждането на нашия JavaScript код. Той ще бъде разположен между последната двойка **script** тагове: 
...
Подробна информация за него, може да намерите тук:
...
***
Библиотеката "jQuery" ни позволява да манипулираме HTML елементи, като използваме валидни селектори за дизайн (**CSS**). Нужно е да използваме конкретен синтаксис:
```js
$ ('#ID') или $ ('.Class')  
```
