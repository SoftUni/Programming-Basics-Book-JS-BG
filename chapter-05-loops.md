...
* Интерактивен онлайн инструмент за чертане с костенурка – [https://ycatch.github.io/p5.turtle.js](https://ycatch.github.io/p5.turtle.js/)

***
Инфо за сваляне и стартиране на демото. В две папки ще има начална и завършена версия. 
***
...
***
Няколко графики имат нужда от туширане на контура. <br>
Спрайтовете не излизат в Хром и Опера.
***
...
Сменете цвета: **`turtle.penColor` = `turtle.color.green`**. 
...
Чертайте в цикъл като движите напред и завъртате. С всяка стъпка увеличавайте с 10 дължината на движението напред и завъртайте на 120 градуса.
