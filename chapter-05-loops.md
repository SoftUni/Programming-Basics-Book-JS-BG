...
```
Първо изтриваме графиките с функцията **cg()** (clear graphics) и построяваме елементарен цикъл, който да се повтори 4 пъти. Целенасочено използваме ключовата дума **"let"** за дефиниране на променливата **"index"**.<br> По този начин гарантираме автономността на променливата за конкретния цикъл и може без проблем да използваме същото наименование отново. 
