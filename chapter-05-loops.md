...
* **jQuery-turtle** - плъгин за библиотеката **jQuery**: [https://github.com/davidbau/jquery-turtle](https://github.com/davidbau/jquery-turtle)
...
Растерна графика, която иползваме с цел по-добра презентация на нашето приложение.
...
Сега можем да преминем към забавната част - писането на JavaScript кода за нашето уеб приложение.<br>
Той ще бъде разположен между последната двойка **script** тагове: 

```html
<script> </script>
```
Кодът за нашето приложение ще бъде сравнително кратък (около 70-80 реда) и затова не е нужно да го отделяме в нов файл. Важно е само да го разположим правилно в нашия HTML файл. Препоръчително е всички JavaScript файлове да се поставят в края на HTML документа, преди завъшващия </body> таг. С това гарантираме по-бързото зареждане на страницата, защото не забавяме рендирането (обрабортването) на елементите и.
