...
[TODO: да се адаптира за JS - има JS Turtle Graphics библиотеки, които ммогат да се ползват, да се намери подходяща]
...
![](assets/old-images/chapter-5-images/13.Turtle-graphics-03.png)
