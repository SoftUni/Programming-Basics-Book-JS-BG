...
![](assets/old-images/chapter-5-images/00.For-loop-02.png)
...
Докато програмираме, постоянно се налага да пишем цикли, десетки пъти всеки ден. Затова в повечето среди за разработка (IDE) има **шаблони за код** (**code snippets**) за писане на цикли. Един такъв шаблон е **шаблонът за `for` цикъл във Visual Studio Code**. Напишете **`for`** в редактора за JavaScript код във Visual Studio Code и **натиснете два пъти** [**Tab**]. VS Code ще разгъне за вас шаблон и ще напише цялостен **`for` цикъл**:

![](assets/old-images/chapter-5-images/00.For-loop-code-snippet-01.png)
