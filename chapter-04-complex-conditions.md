...
Отваряме **`cmd`** с десен клик на мишката върху проекта и стартираме приложението с командата "**`electron .`**":
...
Стойностите на координатите са достъпни чреа **`id`** на **`<input>`** полетата. За по-добра визуализация на екрана, мащабираме стойностите като **`ги увеличaваме 10 пъти`**.
