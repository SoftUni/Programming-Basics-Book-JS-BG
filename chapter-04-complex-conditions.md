...
2. В папката на проекта създаваме JavaScript файл с име "**`main.js`**" като във VSCode натиснем **`[Ctrl+N]`**. След това записваме новия файл с **`[Ctrl+Shift+S]`** и въвеждайки желаното име на файла.
...
Записваме в отделни променливи координатите на двата ъгъла на правоъгълника:
