...
4. В папката на проекта създаваме създаваме и нов **`*.html`** файл с име **`index.html`**. Тагът **`"<title>"`** е задължителен за всеки **`html`** документ и дефинира заглавието му. Влизаме в него и написваме **`"Point in Rectangle"`**:
...
<p align="center"><img src="assets/chapter-4-1-images/14.Point-in-rectangle-gui-07_.png" /></p>
