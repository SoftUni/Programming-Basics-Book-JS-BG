...
![](assets/chapter-7-1-assets/12.Fibonacci-01.png)
...
* Декларираме променлива **`n`**, на която присвояваме целочислена стойност, подадена на фунцкията.
...
![](assets/chapter-7-1-assets/13.Pyramid-01.png)
...
![](assets/chapter-7-1-assets/14.Table-with-numbers-01.png)
