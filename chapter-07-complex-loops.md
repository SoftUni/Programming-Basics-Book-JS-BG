...
<div class="video-player">
  ...
  href="https://www.youtube.com/watch?v=fDVHaakZODU">
  https://www.youtube.com/watch?v=fDVHaakZODU</a>.
</div>
...
![](assets/chapter-7-1-assets/00.Step-explanation-01.png)
...
![](assets/chapter-7-1-assets/01.Numbers-1-to-n-01.png)
...
![](assets/chapter-7-1-assets/02.Numbers-n-to-1-01.png)
...
![](assets/chapter-7-1-assets/03.Numbers-1-tо-2^n-01.png)
...
![](assets/chapter-7-1-assets/04.Even^2-01.png)
...
![](assets/chapter-7-1-assets/00.While-loop-01.png)
...
![](assets/chapter-7-1-assets/05.Numbers-2k+1-01.png)
...
* Декларираме променлива **`num`**, на която присвояваме целочислената стойност на пърия аргумент, подаден на фунцкията.
* За условие на цикъла слагаме израз, който е **`true`**, ако числото **не е** в диапазона, посочен в условието.
* В **тялото на цикъла**: отпечатваме съобщение със съдържание "**Invalid number!**" на конзолата, след което присвояваме нова стойност за **`num`** (следващия аргумент, подаден на функцията).
...
![](assets/chapter-7-1-assets/06.Numbers-in-range-1..100-01.png)
...
* Декларираме променливи **`a`** и **`b`**, на които присвояваме **целочислени** стойности, подадени на фунцкията.
...
![](assets/chapter-7-1-assets/07.GCD-01.png)
...
![](assets/chapter-7-1-assets/00.Do-while-01.png)
...
* Декларираме променливата **`n`**, на която присвояваме целочислена стойност подадена на фунцкията.
...
![](assets/chapter-7-1-assets/08.Factorial-01.png)
...
![](assets/chapter-7-1-assets/09.Sum-digits-01.png)
...
![](assets/chapter-7-1-assets/00.Infinite-while-loop-01.png)

А така изглежда **безкраен `for`** цикъл:

![](assets/chapter-7-1-assets/00.Infinite-for-loop-01.png)
...
* Декларираме променливата **`n`**, на която присвояваме цялото число, което е подадено на фунцкията.
...
![](assets/chapter-7-1-assets/10.Check-if-prime-01.png)
...
* Декларираме променлива **`i`**, на която присвояваме начална стойност **0**. Чрез нея ще запазваме позицията на всяко число, което е подадено на фунцкията.
...
* В **тялото на цикъла**:
   * Вземаме целочислена стойност, която е подадена на фунцкията и я присвояваме на **`num`**.
...
![](assets/chapter-7-1-assets/00.Break-in-infinite-loop-01.png)

Забележка: макар кодът по-горе да е коректен, той няма да работи, ако вместо числа потребителят въведе текст, например “**Invalid number**”. Тогава парсването на текста към число ще се счупи и програмата ще покаже **съобщение за грешка (изключение)**. 
...
![](assets/chapter-7-1-assets/00.Nested-and-break-desired-result-01.png)

Ето едно **грешно решение**, което изглежда правилно на пръв поглед:

![](assets/chapter-7-1-assets/00.Nested-and-break-undesired-result-02.png)

Ако оставим програмата ни по този начин, резултатът ни ще е следният:

![](assets/chapter-7-1-assets/00.Nested-and-break-undesired-result-01.png)
...
![](assets/chapter-7-1-assets/00.Nested-and-break-desired-result-02.png)
...
console.log("Even number entered: {0}", n);
```
