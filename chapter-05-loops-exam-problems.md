...
В променливата **`n`** ще съхраняваме броя на числата, които ще четем от конзолата. Допълнително си декларираме и променливите **`p1`**, **`p2`** и т.н., в които ще пазим броя на числата от съответната група.
...
С **`for` цикъл** преминаваме през всеки рожден ден на Лили. Когато водещата променлива е **нечетно число**, увеличаваме броя на **играчките**. Проверката за четност осъществяваме чрез **деление с остатък** (**`%`**) **на 2** – когато остатъкът е 0, числото е **четно**, а при остатък 1 - **нечетно**.  <br />
Обратно, когато водещата променлива е **четно число**, това означава, че Лили е **получила пари** и съответно прибавяме тези пари към общите ѝ спестявания. **Увеличаваме** стойността на променливата **`moneyFromBirthdays`**, т.е. **увеличаваме с 10** сумата, която тя ще получи на следващия си рожден ден. Едновременно с това **изваждаме по 1 лев** - парите, които брат ѝ взема. Използваме съкратено записване, като добавяме два минуса след последния знак на променливата ( **`moneyFromBirthdays--`**).
...
За да спестим създаването на допълнителни променливи, използваме шаблонен литерал - **`${израз}`**. <br />
...
![](assets/old-images/chapter-5-2-images/03.Back-to-the-past-01.png)
...
![](assets/old-images/chapter-5-2-images/03.Back-to-the-past-02.png)
...
### Насоки и подсказки
Отново започваме, като **декларираме и инициализираме** нужните променливи: 
