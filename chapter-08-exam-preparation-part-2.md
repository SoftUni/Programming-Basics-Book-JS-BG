...
* **Приемане на входните данни**, които потребителя въвежда, **в подходящи променливи**.
...
Можем да **приемем входните данни** по следния начин:

![](assets/old-images/chapter-8-2-images/01.Distance-01.png)
...
![](assets/old-images/chapter-8-2-images/01.Distance-02.png)

По този начин успяхме да се справим успешно с **първата подзадача**. **Следващата** стъпка е да **преобразуваме входните данни** в **числа**, за да можем да извършим необходимите пресмятания. За целта трябва да използваме **Number()** по следния начин:

![](assets/old-images/chapter-8-2-images/01.Distance-03.png)
...
![](assets/old-images/chapter-8-2-images/01.Distance-04.png)
...
![](assets/old-images/chapter-8-2-images/01.Distance-05.png)
...
Приемаме 7 параметъра като вход:
* **Събраните пари**.
* **Широчината на пода**.
* **Дължината на пода**.
...
Следващата задача изисква от нашата програма да приема повече входни данни и извърши по-голям брой изчисления, въпреки че решението е **идентично**. Приемането на данните от потребителя извършваме по добре **познатия ни начин**.
...
Като вход ни се подават **5 параметъра**:
* Първият параметър е **броят на закупените хризантеми** – цяло число в интервала [**0 … 200**].
* Вторият параметър е **броят на закупените рози** – цяло число в интервала [**0 … 200**].
* Третият параметър е **броят на закупените лалета** – цяло число в интервала [**0 … 200**].
* Четвъртият параметър е **сезонът** – [**Spring, Summer, Autumn, Winter**].
* Петият параметър посочва **дали денят е празник** – [**Y - да / N - не**].
...
![](assets/old-images/chapter-8-2-images/05.Grades-03.png)
...
За последната задача имаме по условие входни данни на **3 реда**, които са представени от по един символ от **ASCII таблицата** ([http://www.asciitable.com/](http://www.asciitable.com/)). Бихме могли да използваме вече **дефинирана функция** в езика JavaScript, като преобразуваме входните данни в тип данни **`char`** по следния начин:
