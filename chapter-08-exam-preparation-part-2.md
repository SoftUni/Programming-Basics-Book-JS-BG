...
По този начин успяхме да се справим успешно с **първата подзадача**. **Следващата** стъпка е да **преобразуваме входните данни** в **числа**, за да можем да извършим необходимите пресмятания. За целта трябва да използваме функциите **`parseInt()/parseFloat()`** по следния начин:
...
На функцията се подават 7 аргумента:
* **Събраните пари**.
* **Широчината на пода**.
* **Дължината на пода**.
