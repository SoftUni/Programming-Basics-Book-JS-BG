...
При нужда от закръгляне можем да използваме енда от следната функция:
 ...
 * **`Math.floor(…)`** - в случай, че искаме закръглянето да е винаги **надолу до цяло число**. Например, ако имаме числото 5.99 и използваме **`Math.floor(5.99)`**, ще получим числото **5**.
