...
Второто нещо, което трябва да има вашият шаблон е **`body`**, това е най-сложната част от шаблона. Това всъщност е кодът, който ще се генерира, като в него може да имате **променливи**, които се създават с **`$1`**, като на мястото на единичката може да бъде друг текст. В примера има променлива:
**`"console.log('$1');"`**
...
В тази секция ще покажем накратко **хитрости и техники** от програмирането с езика JavaScript,част от който споменавани вече в тази книга, които ще са ви много полезни, ако ходите на изпит по програмиране за начинаещи:
...
Всичките тези стойности използвани в условната конструкция **if** ще дадат положителен резултат и съответно нашият код ще продължи изпълнението си в тялото на условната конструкция (за целите на примера тук тялото не форматирано правилно).
...
TODO:think about that, remove it or update it
