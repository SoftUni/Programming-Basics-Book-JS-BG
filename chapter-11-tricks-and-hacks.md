...
При нужда от закръгляне можем да използваме следната функция:

 * **`Math.round(…)`** - приема 1 параметър - **числото, което искаме да закръглим**. Закръглянето се извършва по основното правило за закръгляване - ако десетичната част е по-малка 5 закръглението е надолу и отратно, ако е по-голяма от 5 - нагоре.
