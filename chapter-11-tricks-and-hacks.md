...
И двете функции закръглят числа с десетична запетая по основното правило за закръгляване, ако числото е по-малко 5 закръглението е надолу и отратно, ако е по-голямо от 5 - нагоре.
...
В случай, че искаме да закръглим дадено число надолу можем вместо **`Math.round(…)`** да използваме функцията **`Math.floor(…)`**, която винаги **закръгля надолу до цяло число**. Например, ако имаме числото 5.99 и използваме **`Math.floor(5.99)`**, ще получим числото **5**.
...
Ситуацията с останалите оператори за сравнения е подабна и същата логика важи и там.
