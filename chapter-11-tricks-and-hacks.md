...
Всичките тези стойности използвани в условната конструкция **if** ще дадат положителен резултат и съответно нашият код ще продължи изпълнението си в тялото на условната конструкция (за целите на примера тук тялото не е форматирано правилно).
...
if (-Infinity){}  //true
```
Обратно, всички тези стойности, ще дадат отрицателен резултат и кодът няма да влезе в тялото на условната конструкция.
