...
**Избираме JavaScript** от падащото меню и ще се отвори прозорец с наименован  **javascript.json**. Това разширение **json** е един специален формат на записване на данни, който е наложен при начините за пренос и запазване на данни. Освен това, **json** форматът може да се ползва и в нашите програми, както ще разгледаме малко по - късно. Файлът изглежда така:
...
Съществуват и по сложни конфигурации, но като за начало тези ще ни свърщат отлична работа.

Последната част от шаблона е **`description`**, което служи за добавяне на допълнилно пояснение за това, което прави той. Сега нека да пробваме да направим собствен шаблон. Изтриваме дадения пример и въвеждаме следния код:
