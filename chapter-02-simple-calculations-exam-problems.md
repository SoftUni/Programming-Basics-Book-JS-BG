...
На конзолата да се отпечата 1 число - **резултатът от обмяната на валутите** с точно два знака след десетичната запетая.
